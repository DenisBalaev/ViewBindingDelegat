...
import com.example.viewbindingdelegat.databinding.BottomDialogCommandCarScreen2Binding
...
class NewBottom2(private val context: Context, private val layoutInflater: LayoutInflater)
{
    private var bottomSheetDialog: BottomSheetDialog = BottomSheetDialog(context)
    private var binding: BottomDialogCommandCarScreen2Binding = BottomDialogCommandCarScreen2Binding.inflate(layoutInflater)
